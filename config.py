...
parser.add_argument('--mode_SP', type=str, default='number', help='Self-paced Learning apporaches ["number", "noisyLoss"]')
parser.add_argument('--noisy_method', type=str, default='GLC')
parser.add_argument('--eval_on', type=str, default='data/test_0820.tsv')
parser.add_argument('--bias_type', type=str, default='frame', help='select from {frame, demographic, epistemological}')
